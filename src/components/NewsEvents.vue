        ...
        <div class="carousel">
          <div class="slider-wrapper">
            ...
            <div class="slides">
              <!-- Slide 1 -->
              <div class="slide">
                <img src="/images/NEWS.png" alt="News Image 1" />
              </div>
              <!-- Slide 2 -->
              <div class="slide">
                <img src="/images/NEWS (2).png" alt="News Image 2" />
              </div>
              <!-- Slide 3 -->
              <div class="slide">
                <img src="/images/RAILWAY.png" alt="News Image 3" />
              </div>
            </div>
...
input#slide1:checked ~ .dots label:nth-child(1),
input#slide2:checked ~ .dots label:nth-child(2),
input#slide3:checked ~ .dots label:nth-child(3) {
